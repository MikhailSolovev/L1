...
func main() {
	...
	//
	// Последовательная программа работает в среднем в 11 раз быстрее и примерно в 2 раза стабильнее
	// С другой стороны, на более вычислительно сложных задачах эти недостатки нивелируются 
	// 	
